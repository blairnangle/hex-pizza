...
class PriceCalculatorTest {
    ...
    @DisplayName("given a pepperoni pizza costs $0.45 per square inch, " + "and an order comes in for a 12-inch pepperoni pizza, " + "when the order is processed, " + "then the price of the order should be $16.96")
    @Test
    void test() {
